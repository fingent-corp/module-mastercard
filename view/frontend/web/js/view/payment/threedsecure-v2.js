...
define([
    ...
    'Mastercard_Mastercard/js/action/authenticate-payer',
    'Mastercard_Mastercard/js/action/initiate-authentication'
], function (
    ko,
    $,
    Component,
    ...
    return Component.extend({
        defaults: {
            template: 'Mastercard_Mastercard/threedsecure/treedsecure-v2'
        },
        onComplete: null,
        onError: null,
        onCancel: null,
