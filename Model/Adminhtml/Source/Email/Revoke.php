...
class Revoke extends MagentoTemplate
{
    /**
     * @var Registry
     */
    ...
    /**
     * For getting revoke link mail templates
     *
     * {@inheritdoc}
     */
    public function toOptionArray()
    {
        ...
        $customTemplateId = 'payment_pay_by_link_revoke_template';
        $customTemplateLabel = __('Revoke Link (Default)');
